...
var driverController = {
    index: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Driver_repository_1.default.getAllDriver()];
                case 1:
                    listDriver = _a.sent();
    ...
    store: function (req, res) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/];
    }); }); },
    update: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var driverId, payload, driver;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    driverId = req.params.id;
                    payload = req.body;
                    return [4 /*yield*/, Driver_repository_1.default.updateDriver(driverId, payload)];
                case 1:
                    driver = _a.sent();
                    if (driver) {
    ...
    destroy: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    driverId = req.params.id;
                    return [4 /*yield*/, Driver_repository_1.default.deleteDriver(driverId)];
                case 1:
                    user = _a.sent();
                    if (user) {
                        res.status(200).json({
